module.exports = {
  ...
  activate: function(){
    jQuery = require('/Users/travis/programming/icon-font-picker/dist/js/jquery-1.10.2.min.js');
    var iconpicker = require('/Users/travis/programming/icon-font-picker/dist/js/fontawesome-iconpicker.min.js');

    //TODO: create custom html5 element instead of div?
    var element = document.createElement('div');

    //set up css and scripts for iconpicker
    element.innerHTML = '<link href="/Users/travis/programming/icon-font-picker/dist/css/bootstrap.min.css" rel="stylesheet"><link href="/Users/travis/programming/icon-font-picker/dist/css/font-awesome.min.css" rel="stylesheet"><link href="/Users/travis/programming/icon-font-picker/dist/css/fontawesome-iconpicker.min.css" rel="stylesheet"><div class="icp"></div><script src="http://code.jquery.com/jquery-1.10.2.min.js"></script><script src="http://netdna.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min.js"></script><script src="/Users/travis/programming/icon-font-picker/playground/fontawesome-iconpicker/dist/js/fontawesome-iconpicker.js"></script>';
    ...
    pContainer.on('iconpickerSelected', function(){insertText(p.iconpickerValue)});
...
function insertText(value){
  console.log('<i class="fa ' + value + '"></i>');
}

function getPackagePath(){
  return atom.packages.getActivePackage('icon-font-picker').path;
}
